...
// This file was generated with SUS Compiler 0.1.1// ::BitSerialMatrixMultiplyTinyIO
...
/*mux_wire*/ logic [2:0][31:0] split_i;
wire [0:0][31:0] split_left;
wire [1:0][31:0] split_right;
...
/*mux_wire*/ logic [0:0][31:0] _1_values;
wire [31:0] _1_total;
/*mux_wire*/ logic [31:0] right_total;
/*mux_wire*/ logic [1:0][31:0] _2_values;
wire [31:0] _2_total;
wire [31:0] _3 = _left_total_D1 + right_total;
/*latency*/ logic [31:0] __3_D2; always_ff @(posedge clk) begin __3_D2 <= _3; end
SplitAt_T_int_SIZE_3_SPLIT_POINT_1_ split(
	.clk(clk),
	.i(split_i),
	.left(split_left),
	.right(split_right)
...
always_comb begin
	// Combinatorial wires are not defined when not valid. This is just so that the synthesys tool doesn't generate latches
	left_part[0] = 'x;
	left_part = split_left;
end
always_comb begin
	// Combinatorial wires are not defined when not valid. This is just so that the synthesys tool doesn't generate latches
	right_part[0] = 'x;
	right_part[1] = 'x;
	right_part = split_right;
end
always_comb begin
	// Combinatorial wires are not defined when not valid. This is just so that the synthesys tool doesn't generate latches
	split_i[0] = 'x;
...
/*mux_wire*/ logic [1:0][31:0] split_i;
wire [0:0][31:0] split_left;
wire [0:0][31:0] split_right;
/*mux_wire*/ logic [31:0] left_total;
/*mux_wire*/ logic [0:0][31:0] _1_values;
wire [31:0] _1_total;
/*mux_wire*/ logic [31:0] right_total;
...
wire [31:0] _2_total;
wire [31:0] _3 = left_total + right_total;
/*latency*/ logic [31:0] __3_D1; always_ff @(posedge clk) begin __3_D1 <= _3; end
SplitAt_T_int_SIZE_2_SPLIT_POINT_1_ split(
	.clk(clk),
	.i(split_i),
	.left(split_left),
	.right(split_right)
...
/*mux_wire*/ logic [4:0][31:0] split_i;
wire [1:0][31:0] split_left;
wire [2:0][31:0] split_right;
/*mux_wire*/ logic [31:0] left_total;
/*latency*/ logic [31:0] _left_total_D2; always_ff @(posedge clk) begin _left_total_D2 <= left_total; end
/*mux_wire*/ logic [1:0][31:0] _1_values;
wire [31:0] _1_total;
/*mux_wire*/ logic [31:0] right_total;
/*mux_wire*/ logic [2:0][31:0] _2_values;
wire [31:0] _2_total;
wire [31:0] _3 = _left_total_D2 + right_total;
/*latency*/ logic [31:0] __3_D3; always_ff @(posedge clk) begin __3_D3 <= _3; end
SplitAt_T_int_SIZE_5_SPLIT_POINT_2_ split(
	.clk(clk),
	.i(split_i),
	.left(split_left),
	.right(split_right)
...
/*mux_wire*/ logic [2:0][31:0] right_part;
/*mux_wire*/ logic [5:0][31:0] split_i;
wire [2:0][31:0] split_left;
wire [2:0][31:0] split_right;
/*mux_wire*/ logic [31:0] left_total;
/*mux_wire*/ logic [2:0][31:0] _1_values;
wire [31:0] _1_total;
/*mux_wire*/ logic [31:0] right_total;
/*mux_wire*/ logic [2:0][31:0] _2_values;
wire [31:0] _2_total;
wire [31:0] _3 = left_total + right_total;
/*latency*/ logic [31:0] __3_D3; always_ff @(posedge clk) begin __3_D3 <= _3; end
SplitAt_T_int_SIZE_6_SPLIT_POINT_3_ split(
	.clk(clk),
	.i(split_i),
	.left(split_left),
	.right(split_right)
...
/*mux_wire*/ logic [1:0][31:0] left_part;
/*mux_wire*/ logic [1:0][31:0] right_part;
/*mux_wire*/ logic [3:0][31:0] split_i;
wire [1:0][31:0] split_left;
wire [1:0][31:0] split_right;
/*mux_wire*/ logic [31:0] left_total;
/*mux_wire*/ logic [1:0][31:0] _1_values;
...
wire [31:0] _3 = left_total + right_total;
/*latency*/ logic [31:0] __3_D2; always_ff @(posedge clk) begin __3_D2 <= _3; end
SplitAt_T_int_SIZE_4_SPLIT_POINT_2_ split(
	.clk(clk),
	.i(split_i),
	.left(split_left),
	.right(split_right)
